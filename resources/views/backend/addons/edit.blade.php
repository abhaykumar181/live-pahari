                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control shadow-sm post-description" name="description" id="description" rows="11">{{$addons->description}}</textarea>
                                            </div>

                                            <div class="mb-3">
                                                <label for="excerpt" class="form-label">Excerpt <span class="required">*</span></label>
                                                <textarea class="form-control shadow-sm " name="excerpt" id="excerpt" rows="5">{{$addons->excerpt}}</textarea>
                                            </div>                                            
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3 ">
                                                ...
                                                <img src="{{ asset('storage/images/'.$addons->thumbnail.'') }}" id="uploadPreview" class="img-thumbnail" style="height:130px;width:100%" alt="image">
