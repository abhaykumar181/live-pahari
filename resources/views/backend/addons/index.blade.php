                ...
                <div class="col-md-12">
                    <div class="card card-white rounded-0">
                        ...
                        <div class="card-header bg-white py-3 ">
                            <div class="row">
                                <div class="col-md-6 mb-0 my-auto"><h5>All Addons</h5></div>
                                <div class="col-md-6 mb-0 my-auto text-end"><a class="btn shadow-sm btn-primary" href="{{route('admin.addons.create')}}">Create Addons</a></div>
                            </div>
                        </div>
